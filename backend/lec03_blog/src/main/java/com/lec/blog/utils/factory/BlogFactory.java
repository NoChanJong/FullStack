package com.lec.blog.utils.factory;
...
public class BlogFactory {
    ...
    private static List<BlogUser> generateBlogUsers() {
        return Stream.generate(BlogFactory::generateBlogUser)
                ...
                // .toList()                   // JDK17
                .collect(Collectors.toList()); // JDK11
    }
    ...
    private static BlogUser generateBlogUser() {
        ...
        return new BlogUser(
                ...
                // "%s.%s@mail.com".formatted(name.getFirstName(), name.getLastName())   // JDK17
                String.format("%s.%s@mail.com", name.getFirstName(), name.getLastName()) // JDK11
        );
    }
